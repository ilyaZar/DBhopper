...
const configSchema = Type.Object(
  {
    ...
    dbClientId: Type.Optional(
      Type.String({
        description:
          "DB API Marketplace Client ID. Can also be supplied as DB_CLIENT_ID.",
      }),
    ),
    dbApiKey: Type.Optional(
      Type.String({
        description:
          "DB API Marketplace Client Secret/API key. Can also be supplied as DB_API_KEY.",
      }),
    ),
    ...
    delayProvider: Type.Optional(
      Type.Union([
        ...
        default: "auto",
        description:
          "Delay provider. auto uses DB Timetables when credentials exist, otherwise bahn-web.",
      }),
    ),
