...
export declare function runDbDelayQuery(params: DbDelayQueryToolParams, config?: DBhopperConfig, signal?: AbortSignal): Promise<{
    ...
    provider_selection: {
        ...
        requested: "db-timetables" | "bahn-web";
        selected: "db-timetables" | "bahn-web";
        reason: string;
    };
    research: {
        official: {
    ...
    delayed_regional_candidates: {
        journey: {
            ...
            cancelled: boolean;
            source: string | undefined;
            route_confidence: "full_stop_list" | "station_board_path" | "unknown" | undefined;
            stops: string[] | {
                raw?: unknown;
                station: {
                    name: string;
