export function extractDbErrorMessage(body) {
...
export function diagnoseDbApiCredentialResponse(status, dbErrorMessage = "") {
    if (status === 401 &&
...
export function diagnoseDbApiCredentialErrorMessage(message) {
...
function normalizeDbErrorText(value) {
