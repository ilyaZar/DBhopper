...
describe("dbhopper package metadata", () => {
  ...
  it("keeps private runtime paths ignored and out of package output", async () => {
    ...
    const ignoredPaths = [
      ...
      "assets/private/purchases/test-runs/ticket-purchase-test-run-2026-06-16T09-00-00-000Z/01_ticket-checkout-home.txt",
      "assets/private/purchases/test-runs/ticket-purchase-test-run-2026-06-16T09-00-00-000Z/09_ticket-checkout-review.png",
